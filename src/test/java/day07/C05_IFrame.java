...
————————————
Explain how you can switch back from a main page? z_Tekrar_lar.Tekrar ana sayfaya nasil donersin?
***2 farkli yol vardır.
...
Yanlis locator. Cozum : z_Tekrar_lar.Tekrar elementi locate etmek. Değişken element var ise ona gore dynamic bir xpath yazarız.
