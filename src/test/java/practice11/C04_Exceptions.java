...
public class C04_Exceptions extends TestBase {
      /*
    ...
    public void name() {
        ...
        //Cikan urunlerde sadece Apple iphone yazanalari tiklayalim
     List<WebElement> urunler =driver.findElements(By.partialLinkText("Apple iPhone"));

     for (int i =0; i<urunler.size(); i++) {
         urunler =driver.findElements(By.partialLinkText("Apple iPhone"));//StaleElementReferenceException HATASINI HANDLE ETMEK ICIN LOOP ICINE LISTI KOYMALIYIZ
         urunler.get(i).click();
