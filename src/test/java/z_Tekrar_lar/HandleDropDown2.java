...
public class HandleDropDown2 extends TestBase {
    ...
    public void test() {
        ...
        WebElement ddn = driver.findElement(By.xpath("//select[@id='pc_currency']"));
        ...
        WebElement sec = driver.findElement(By.xpath("//input[@id='pc_inDollars_true']"));
        Assert.assertFalse(sec.isSelected());
...
driver.findElement(By.xpath("//input[@id='purchase_cash']")).click();
      ...
      WebElement foreGorunur =   driver.findElement(By.xpath("//div[@id='alert_content']"));
      Assert.assertTrue(foreGorunur.isDisplayed());
