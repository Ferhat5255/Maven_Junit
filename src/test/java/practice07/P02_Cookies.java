...
//Techproeducation adresine gidiniz
    ...
    public void test01() {
        ...
        System.out.println("cookie2'lerin sayisi = " + cookies2.size());
        ...
        System.out.println("cookie3'lerin sayisi = " + cookies3.size());

        //Tüm cookieleri silelim
        driver.manage().deleteAllCookies();

        Set<Cookie> cookies4 = driver.manage().getCookies();
        System.out.println("cookie4'lerin sayisi = " + cookies4.size());
    }
}
